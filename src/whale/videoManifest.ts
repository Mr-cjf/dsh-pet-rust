...
export const MANIFEST: Record<AnimKey, VideoManifestEntry> = {
  ...
  work_cube: { file: 'thumb/work_cube.webm', loop: false, category: 'work' },
  work_toycar: { file: 'thumb/work_toycar.webm', loop: false, category: 'work' },
  work_tap: { file: 'thumb/work_tap.webm', loop: false, category: 'work' },
  ...
  act_rage: { file: 'thumb/act_rage.webm', loop: false, category: 'act' },
  ...
  react_bow: { file: 'thumb/react_bow.webm', loop: false, category: 'react' },
  react_scared: { file: 'thumb/react_scared.webm', loop: false, category: 'react' },
